...
software_architecture_refine_template = """
I am providing the description of a system we want to design. Additionally, I am also including a high-level architecture for the system generated by a large language model (LLM). Your task is to:
1. Consider the functional and non-functional requirements of the system
2. Analyze the LLM-generated architecture
3. Identify any issues therein
4. Rectify them and output the corrected code.
The description is as follows
System: {description}
LLM-generated diagram: {llm_diagram}
Answer:"""
software_architecture_refine_prompt = PromptTemplate(
    input_variables=["description", "llm_diagram"],
    template=software_architecture_refine_template
)

software_architecture_fill_template = """
I am providing the description of a system we want to design. Additionally, I am also including a high-level architecture for the system generated by a large language model (LLM). Your task is to:
1. Consider the functional and non-functional requirements of the system
2. Analyze the LLM-generated architecture
3. Identify any *gaps* therein (that is, exclusively *missing* components and connections)
4. *Fill* them and output the corrected code.
The description is as follows
System: {description}
LLM-generated diagram: {llm_diagram}
Answer:"""
software_architecture_fill_prompt = PromptTemplate(
    input_variables=["description", "llm_diagram"],
    template=software_architecture_refine_template
)

software_architecture_remove_template = """
I am providing the description of a system we want to design. Additionally, I am also including a high-level architecture for the system generated by a large language model (LLM). Your task is to:
1. Consider the functional and non-functional requirements of the system
2. Analyze the LLM-generated architecture
3. Identify any *redundancies* therein (that is, exclusively *superfluous* components and connections)
4. *Remove* them and output the corrected code.
The description is as follows
System: {description}
LLM-generated diagram: {llm_diagram}
Answer:"""
software_architecture_remove_prompt = PromptTemplate(
    input_variables=["description", "llm_diagram"],
    template=software_architecture_refine_template
)
